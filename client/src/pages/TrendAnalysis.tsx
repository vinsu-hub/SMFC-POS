...
export default function TrendAnalysis() {
  ...
  const heatmapData = [
    ...
    { product: 'Duck Confit', jan: 38, feb: 35, mar: 32, apr: 28, may: 25, jun: 22 },
    { product: 'Halibut', jan: 42, feb: 44, mar: 46, apr: 48, may: 50, jun: 52 },
    { product: 'Ribeye', jan: 55, feb: 54, mar: 53, apr: 52, may: 51, jun: 50 },
        ...
        <Card className="border-l-4 border-l-[#1B2A4A] bg-gradient-to-r from-blue-50 to-transparent">
          <CardContent className="p-6">
            ...
            <ul className="space-y-2 text-sm font-corp-body text-gray-700">
              ...
              <li>✓ Traditional proteins (Ribeye, Oysters) are declining — consider rotating menu</li>
